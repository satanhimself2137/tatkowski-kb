# kb.ps1 v2 - stateless Tatkowski KB helper. Self-timeouts so a hung gh call can never block Desktop Commander.
# Usage: .\kb.ps1 read   |   .\kb.ps1 write -By Maciej -Message "what changed"
param(
